    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="/assets/img/logo.svg" class="mr-2"
                        alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="index.html"><img src="/assets/img/logo-mini.svg"
                        alt="logo" /></a>
            </div>
                    ...
                    <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                        ...
                        <ul class="chat-list">
                            <li class="list active">
                                <div class="profile"><img src="/assets/img/faces/face1.jpg" alt="image"><span
                            ...
                            <li class="list">
                                <div class="profile"><img src="/assets/img/faces/face2.jpg" alt="image"><span
                            ...
                            <li class="list">
                                <div class="profile"><img src="/assets/img/faces/face3.jpg" alt="image"><span
                                        class="online"></span></div>
                                <div class="info">
                                    <p>Daniel Russell</p>
                                    <p>Available</p>
                            ...
                            <li class="list">
                                <div class="profile"><img src="/assets/img/faces/face4.jpg" alt="image"><span
                                        class="offline"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img src="/assets/img/faces/face5.jpg" alt="image"><span
                                        class="online"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img src="/assets/img/faces/face6.jpg" alt="image"><span
                                        class="online"></span></div>
                                <div class="info">
                                    <p>Sarah Graves</p>
                                    <p>Available</p>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card tale-bg">
                                <div class="card-people mt-auto">
                                    <img src="/assets/img/dashboard/people.svg" alt="people">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="icon-data-list">
                                        <li>
                                            <div class="d-flex">
                                                <img src="/assets/img/faces/face1.jpg" alt="user">
                                                <div>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                <img src="/assets/img/faces/face2.jpg" alt="user">
                                                <div>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                <img src="/assets/img/faces/face3.jpg" alt="user">
                                                <div>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                <img src="/assets/img/faces/face4.jpg" alt="user">
                                                <div>
                                        ...
                                        <li>
                                            <div class="d-flex">
                                                <img src="/assets/img/faces/face5.jpg" alt="user">
                                                <div>
