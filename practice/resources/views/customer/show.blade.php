                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <img src="/assets/img/uploads/{{ $customer->profile_pic }}" alt="avatar"
                                class="rounded-circle img-fluid" style="width: 200px; height:220px">
                            <h5 class="my-3">{{ $customer->name }}</h5>
                            <p class="text-muted mb-1">Full Stack Developer</p>
                            <p class="text-muted mb-4"> {{ $customer->city }}, {{ $customer->state }},
                                {{ $customer->country }}</p>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">{{ $customer->address }}, {{ $customer->city }}, {{ $customer->state }},
                                        {{ $customer->country }}</p>
                                </div>
                            </div>
                        </div>
